        ...
        <div className="w-[500px] aspect-[5/2.1] max-h-[210px] flex gap-3">
            ...
            <div className="basis-[65%] h-full relative flex flex-col">
                <div className="-mt-1 text-sm font-medium flex items-center gap-1">
                    <IoCalendarSharp />
                    <p className=""> {show.date.toLocaleDateString("en-US", { weekday: 'long', month: 'long', day: 'numeric' })}, {formatTime(show.start)} - {formatTime(show.end)}</p>
                </div>
                ...
                <div className="flex-grow overflow-hidden flex flex-col gap-[6px]">
