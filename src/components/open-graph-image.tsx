  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-bgcol text-textcol">
      <div className="w-[1200px] h-[600px] border border-accentcol relative">
        <BackgroundImage src='/images/uploads/rex-centered.jpg' alt='Picture of me playing the saxophone' gradientDirClass='bg-gradient-to-t' middleColourPercentClass='via-25%' priority={true} sizes="100vw" />
